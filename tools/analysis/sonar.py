...
PROJECT_KEY = "CIRISAI_CIRISBridge"
    ...
    try:
        if args.command == "list":
            ...
            try:
                ...
                print("CIRISBridge Quality Status")
                print("=" * 40)
            ...
            print("=" * 70)
            print("\nNote: SonarCloud analysis runs after successful CI (~15 minutes)")
            print("=" * 70)
            ...
            try:
                ...
                if qg_status.get("conditions"):
                    print("\nConditions:")
                    for condition in qg_status["conditions"]:
                        cond_status = "+" if condition["status"] == "OK" else "X"
                ...
                print(f"\n[X] Quality Gate: Could not retrieve status ({e})")
